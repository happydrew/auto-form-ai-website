...
const logo = (
  <div className="flex justify-center items-center" title="AutoFormAI">
    <AutoFormAIIcon alt="AutoFormAI" className="h-8 w-8" />
    <span className={`${inter.className} font-bold  ml-2 text-xl mt-1 text-gray-900 dark:text-gray-400`}>AutoFormAI</span>
  </div>
)
